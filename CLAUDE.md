...
We're working on a D&D character sheet generation system that converts YAML character data into professional LaTeX-typeset character sheets.

  - templates/ has LaTeX styles and sheet-layout templates
