...
\newcommand\showplayer[1]{%
  \begingroup
    ...
    \multicolumn1{l}{%
      \getDND*{CLASS} {\small L\getDND+{LEVEL}{?}} \emph{\getDND*{CHARACTER NAME}}
      (\getDND*{RACE})
    }%
    \\
    \hline
  ...
  \endgroup
    ...
    \whenDNDnonempty{MAGIC}{Spell attack \psatk. }%
    ...
    \hline
    \end{tabular}%
    \vskip 0pt plus 5\baselineskip \penalty-200 \vskip 0pt plus -5\baselineskip
  \endgroup
}
...
\whenDNDplayer5{\showplayer5}

\whenDNDplayer6{\showplayer6}

\whenDNDplayer7{\showplayer7}

\whenDNDplayer8{\showplayer8}

\ifDNDplayer6{\onecolumn   \vbox to \dimexpr\textheight-\topskip-4\baselineskip\relax \bgroup\vss}{\bigskip}
%\ifDNDplayer6{\onecolumn  \vbox to \vsize \bgroup\vss}{\bigskip}

\newcommand\offensesection{%
...
\newcommand\durablestripletable[3]{%
  \begingroup
    \def\durable##1##2{##1&##2\\}%
    \begin{tabular}{@{}l@{\hspace*{5\tabcolsep}}l@{\hspace*{5\tabcolsep}}l@{}}
      \begin{tabular}[t]{@{}el@{}}
         #1
      \end{tabular}
      &
...
\ifDNDplayer6{%
  \expandafter\durablestripletable\durablestriple % \durables set in stats, 3 columns
}{%
