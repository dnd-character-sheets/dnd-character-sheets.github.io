...
\def\sam{\bracket{\footnotesize\textsc{Spell ability modifier}}}
\def\spelldc{\bracket{\footnotesize\textsc{Spell DC}}}
\def\spellattack{\bracket{\footnotesize\textsc{Spell Attack}}}
\def\ssatk{~\spellattack}
\def\psatk{+\spellattack}
\def\psam{+\sam}
%\columnseprule=0.4pt
\columnsep=25pt
