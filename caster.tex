...
% top, whatever is higher
  ...
  \node (proficiencies)
   ...
   {\nodepart{label}PROFICIENCIES\nodepart{text}
     ...
     \whenDNDnonempty{MAIN PROFICIENCIES}\profstrue
     \whenDNDnonempty{OTHER PROFICIENCIES}\profstrue
     \begin{proflist}
     \getDND*{MAIN PROFICIENCIES}
     \whenDNDnonempty{MAIN PROFICIENCIES}{%
         \whenDNDnonempty{PROFICIENCIES}{\profskip}}
     \getDND*{PROFICIENCIES}
     \whenDNDnonempty{PROFICIENCIES}{%
         \whenDNDnonempty{OTHER PROFICIENCIES}{\profskip}}
