...
\tracingmacros=1
    ...
    \\
    \whenDNDnonempty{BONUS ACTIONS}{\textbf{Bonus:} \commasep{\getDND{BONUS ACTIONS}}.\\}%
...
\begin{tabular}[t]{@{}el@{}}
{Bane \C}&\?1~min.\\
%\st{Beast Sense \C}&\?1~hour\\
Bless \C [VSM]&\?1~min.\\
Charm Person &\?1~hour\\
%Languages&\?1~hour\\
%Detect Magic&10~min.\\
Divine Favor [VS]&\?1~min.\\
%Feather Fall&\?1~min.\\
%Mage Armor&\?8~hours\\
%Mage Hand&\?1~min.\\
Light [VM]&\?1~hour\\
%Minor Blessing&1~round\\
%&+1~turn\\
\end{tabular}
\qquad
\begin{tabular}[t]{@{}el@{}}
%Friends \C&\?1~min.\\
%Heroism \C&\?1~min.\\
Hunter's Mark \C&\?1~hour\\
%Light&\?1~hour\\
%Rage&\?1~min.\ (combat only)\\
Resistance \C [VSM]&\?1~min.\\
%Sanctuary&\?1~min.\\
%Shield&\?1~round\\
Shield of Faith \C [VSM]&10~min.\\
Speak with Animals [VS]&10~min.\\
%Spiritual Weapon&\?1~min.\\
%Silent Image \C&10~min.\\
%Sleep&\?1~min.\\
\end{tabular}
