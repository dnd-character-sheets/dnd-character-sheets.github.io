...
MAGIC:
  ...
  - name: Guiding Bolt
    ...
    description: >-
       Ranged spell attack \psatk, 120 ft, 4d6 radiant damage;
...
Notes:
  ...
  - In the description of Guiding Bolt, `\psatk` stands for "plus spell attack modifier," and it asks the system to calculate the modifier.
